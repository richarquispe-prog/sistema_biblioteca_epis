...
<div class="container">	
	...
	<div class="mb-3">
		...
		<center> <a href="lista_Usuario.php" class="btn btn-secondary" onclick="return confirm('¿Esta Seguro que desea volver?'); false">Volver</a>
		<!--	<button type="button" class="btn btn-primary">Prestar</button>-->

<input type="submit" value="Guardar"  class="btn btn-primary" onclick="return confirm('¿Esta Seguro que desea Guardar?'); false">
