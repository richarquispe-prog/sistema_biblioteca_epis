				...
				<div class="table-responsive">
					<table  id="example" class="table table-sm" style="width:100%" >
						...
						<tr>
							...
							<td>
								<a href="../../Controller/eliminar_usuario.php?DNI=<?php echo $mostrar['DNI']; ?>" class="btn btn-danger" onclick="return confirm('¿Esta Seguro?'); false">
								Eliminar
								</a>
							</td>
						</tr>
    ...
    <div class="modal-content">
	  ...
	  <form action="../../Controller/registrar_usuario.php" method="post">
		  ...
		  <div class="modal-footer">
		  	<button type="button" class="btn btn-secondary" data-bs-dismiss="modal" aria-label="Close" onclick="return confirm('¿Esta Seguro que deseas cancelar?'); false">Cancelar</button>
